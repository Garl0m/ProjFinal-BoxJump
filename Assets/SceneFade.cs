...
public class SceneFade : MonoBehaviour
{
    ...
    private IEnumerator FadeCoroutine(Color starColor, Color targetColor, float duration)
    {
        float elapsedTime = 0;
        ...
        while (elapsedPercentage < 1)
        {
            ...
            _sceneFadeImage.color = Color.Lerp(starColor, targetColor, elapsedPercentage);
